...
/**
 * Nireneko Manager Service.
 *
 * Esta clase es una copia de un servicio del core modificado para que cargue el menu
 * nireneko en lugar del admin, solo es para los menus que no tienen una ruta definida.
 */
class NirenekoManager {
  ...
  /**
   * Constructs a NirenekoManager object.
   *
  ...
  public function getBlockContents() {
    ...
    $link = $this->menuActiveTrail->getActiveLink('nireneko');
